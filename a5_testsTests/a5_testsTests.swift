...
import XCTest
@testable import a5_tests

final class a5_testsTests: XCTestCase {
    ...
    func testStronglyNegative(){
        ...
        //when
        let tokens = analyzer.categorizeValue(value: -99)
    ...
    func testNegative(){
        ...
        //when
        let tokens = analyzer.categorizeValue(value: -10)
    ...
    func testNeutral(){
        ...
        //when
        let tokens = analyzer.categorizeValue(value: 0)
